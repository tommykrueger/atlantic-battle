<div class="fleets index">
	...
	<tr>
		<td><?php echo h($fleet['Fleet']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($fleet['Fleet']['description']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $fleet['Fleet']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $fleet['Fleet']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $fleet['Fleet']['id']), null, __('Are you sure you want to delete # %s?', $fleet['Fleet']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
