...
<?php echo $this->Form->create('ShipClass'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ship Class'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ShipClass.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ShipClass.id'))); ?></li>
